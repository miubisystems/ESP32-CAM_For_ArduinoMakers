...
<html>
    ...
    <br/>
    <div align=center> 
    <button class="button" id="forward" onclick="fetch(document.location.origin+'/control?var=ccoip&val=1');" >Forward</button>
    </div>
    <br/>
    <div align=center> 
    <button class="button" id="turnleft" onclick="fetch(document.location.origin+'/control?var=ccoip&val=2');">Turn Left</button>
    <button class="button" id="stop" onclick="fetch(document.location.origin+'/control?var=ccoip&val=3');">Stop</button>
    <button class="button" id="turnright" onclick="fetch(document.location.origin+'/control?var=ccoip&val=4');">Turn Right</button>
    </div>
    <br/>
     <div align=center> 
    <button class="button" id="backward" onclick="fetch(document.location.origin+'/control?var=ccoip&val=5');">Backward</button>
    </div>
    <br/>
    </body>
</html>
